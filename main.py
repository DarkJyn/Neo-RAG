...
from metrics_rag import hit_k,recall_k,precision_k,f1_k,map_k, mrr_k,ndcg_k,context_precision_k,context_recall_k,context_entities_recall_k,string_presence_k
...
#print("hit@3:", hit_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db,k=3)) # đặt là True nếu là tập train, False là tập test#
#print("hit@5:", hit_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db,k=5)) # đặt là True nếu là tập train, False là tập test#
#print("hit@7:", hit_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db,k=7)) # đặt là True nếu là tập train, False là tập tes##t#